...
const page = () => {
  ...
  return (
    <div className="service-condition">
      <span className="service-condition--agree">
        비즈토스에 가입하기 위해 다음 약관에 동의해 주세요.
      </span>

      <div className="service-condition--form">
        <div>
          <input
            type="checkBox"
            ...
            checked={allCheck}
          />
          <label className="condition--label" htmlFor="all">
        ...
        <div>
          ...
          />
          <label className="condition--label" htmlFor="use">
            이용 약관 동의 <span className="condition--mandatory">(필수)</span>
          </label>
        </div>
        <div className="condition--info">
          ...
          <br />
          <br />
          본 이용약관은 “비즈토스”(이하 "사이트")의 서비스의 이용조건과 운영에
          ...
          제 17조 취소 및 환불 <br />
          <br />
          ① 회원은 결제한 컨텐츠 또는 서비스를 제공받기 전 사이트에 취소 및
          환불을 요청할 수 있으며, 이에 해당하는 경우 사이트는 전액을
          환불합니다.
          <br />
          ② 회원은 서비스를 제공받기에 앞서 사전에 진행되는 상담 단계에서 취소
          및 환불을 요청할 수 있으며, 이에 해당하는 경우 사이트는 전액을
          환불합니다.
          <br />
          ③ 회원은 사이트에서 판매하는 컨텐츠를 다운로드한 이후, 전자 자료의
          손상 등 심각한 훼손이 없는 경우 취소 및 환불을 요청할 수 없습니다.
          <br />
          <br />
          부칙
          <br />
        ...
        <div>
          <input
            ...
            onChange={() => {
              setPersonalCheck((prev) => !prev);
            }}
          />
          <label className="condition--label" htmlFor="personal">
            개인정보 수집 밎 이용 동의
            <span className="condition--mandatory">(필수)</span>
          </label>
        </div>
        <div className="condition--info">
        ...
        <div>
          ...
          />
          <label className="condition--label" htmlFor="age">
            만 14세 이상입니다.
            <span className="condition--mandatory"> (필수)</span>
          </label>
        </div>
        ...
        <p style={{ textAlign: "center" }}>
          <Link href="/usertype" className="condition--cancel">
            취소
          </Link>

          <button
            onClick={() => handleRouteToForm()}
            className="condition--signup"
          >
            가입하기
          </button>
        </p>
